...
public class PlayerMovement: MonoBehaviour
{
    ...
    void Awake(){//Napravimo slojnu masku za pod
        podnaMaska = LayerMask.GetMask("Floor");//Postavljanje referenci
    ...
    void FixedUpdate()
    {
        ...
        float v = Input.GetAxisRaw("Vertical");//Edit-->Project Settings-->Input --->Horizontal... Vertical...
    ...
    void Move(float h, float v)
    {
        ...
        kretanje.Set(h, 0f, v);
        //Vektor kretanjatreba biti proporcionalan kretanju i vremenu
